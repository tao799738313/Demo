...
, function(module, exports, __webpack_require__) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                for (; ; )
                    ...
                    case 2:
						...
						// get可以换成post方法
                        get("http://ssm.pdt1997.top/it/list?pageNo=18&pageSize=10&secondaryId=all", {
                            id: '10517725' || nodeId
                        });
                    case 12:
	...
	// 添加自己的方法
	, pdtTest = exports.pdtTest = function() {
	    var t = (0,
	    _asyncToGenerator3.default)(_regenerator2.default.mark(function t() {
	        var e;
	        return _regenerator2.default.wrap(function(t) {
    ...
    var fmtUrl = function(t) {
      ...
      , get = function(t, e) {  // 封装axios-promise的get
      ...
      , post = function(t, e, n) {  // 封装axios-promise的post
        return n = n || {},
        new _promise2.default(function(r, o) {
            _axios2.default.post(t, e, {
                headers: n
    ...
    var u = function() {
        ...
        i.default)(t, [{
            ...
            value: function(t) {
                ...
                this.generateNodeData(t.inverst, "invest"),
            ...
            value: function() {
                ...
                }).enter().append("tspan").text(function(t) {   // t = 'xxxx有限公司'
                    return t
				...
				// 添加按钮,点击弹出公司详情
				var m = e.append("g").attr("transform", "translate(" + (t.blockWidth-15) + "," + (t.blockHeight-15) + ")").on("click", function() {
                    document.querySelector('#mask').style.display='block';
                });
				m.append("circle").attr("class", "mask-circle pointer").attr("r", 6);
            }
        }, {
            key: "drawArrow",
            value: function() {
            ...
            value: function(t) {
                ...
                r.setAttribute("height", c.height + 2 * e.y);
                var l = (new XMLSerializer).serializeToString(r);
                l = '<?xml version="1.0" standalone="no"?>\r\n' + l;
                var u = "data:image/svg+xml;charset=utf-8," + encodeURIComponent(l)
                ...
                d.onload = function() {
                    if (t)
                        ...
                        r.write(l),
                        r.close(),
                        r.execCommand("SaveAs", !0, "企业架构图—" + this.root.name + "—天眼查.svg")
                    } else {
                        h.drawImage(d, 0, 0);
        ...
        a.default)(e, [{
            ...
            value: function(t) {
                ...
                this.enterpriseSvg.clickHandler = function(t, n, o, i) {
					...
					// 这里可以重新请求新的数据  e.enterpriseSvg.setup(t.data)
					if(t===1){
				...
				// 触发自定义的请求
				(0,y.pdtTest)(n).then(function(t) {
					console.log(t)
				}),
                (0,y.getEnterpriseMap)(n).then(function(t) {
					// console.log(t)
					console.log("核心")
					var t = {"state":"ok","message":"","special":"","vipMessage":"","isLogin":0,"data":{"id":209252214,"holder":[{"id":2998853466,"percent":"59.26%","type":1,"name":"无限售条件内资股（A股）"},{"id":2998853461,"percent":"40.74%","type":1,"name":"无限售条件外资股（H股）"}],"staff":[{"id":1810028410,"typeJoin":"董事","type":2,"cid":209252214,"name":"刘宏"},{"id":2175042589,"typeJoin":"董事","type":2,"cid":209252214,"name":"谢吉人"},{"id":1999809481,"typeJoin":"董事","type":2,"cid":209252214,"name":"杨小平"},{"id":1871276592,"typeJoin":"董事","type":2,"cid":209252214,"name":"姚波"},{"id":1879709419,"typeJoin":"董事","type":2,"cid":209252214,"name":"孙建一"},{"id":1794914918,"typeJoin":"董事","type":2,"cid":209252214,"name":"储一昀"},{"id":2070647144,"typeJoin":"监事","type":2,"cid":209252214,"name":"王志良"},{"id":2144872913,"typeJoin":"董事","type":2,"cid":209252214,"name":"葛明"},{"id":2027290101,"typeJoin":"董事","type":2,"cid":209252214,"name":"欧阳辉"},{"id":1810590385,"typeJoin":"董事","type":2,"cid":209252214,"name":"刘崇"},{"id":2066853190,"typeJoin":"董事","type":2,"cid":209252214,"name":"王勇健"},{"id":2279587043,"typeJoin":"董事长","type":2,"cid":209252214,"name":"马明哲"},{"id":2155504660,"typeJoin":"董事","type":2,"cid":209252214,"name":"蔡方方"},{"id":2055616195,"typeJoin":"监事","type":2,"cid":209252214,"name":"潘忠武"},{"id":1775180146,"typeJoin":"董事,总经理","type":2,"cid":209252214,"name":"任汇川"},{"id":1987808388,"typeJoin":"董事","type":2,"cid":209252214,"name":"李源祥"},{"id":2274153318,"typeJoin":"监事","type":2,"cid":209252214,"name":"顾立基"},{"id":1929638722,"typeJoin":"监事","type":2,"cid":209252214,"name":"张王进"},{"id":1777117693,"typeJoin":"董事","type":2,"cid":209252214,"name":"伍成业"},{"id":2297144105,"typeJoin":"监事","type":2,"cid":209252214,"name":"黄宝魁"}],"historyHolder":[{"type":1,"id":577814590,"name":"林芝新豪时投资发展有限公司"},{"type":1,"id":166479064,"name":"绵阳市西米商贸有限公司"},{"type":1,"id":212106280,"name":"工布江达江南实业发展有限公司"},{"type":1,"id":605198021,"name":"武汉博胜学术交流有限公司"}],"name":"中国平安保险（集团）股份有限公司","branch":[{"type":1,"id":1121260433,"name":"中国平安保险（集团）股份有限公司工会工作委员会"},{"type":1,"id":3262113841,"name":"中国平安保险公司抚顺办事处何广彬代办站"},{"type":1,"id":2441595277,"name":"中国平安保险公司成都分公司中国银行邛崃市支行兼业务保险代办处"},{"type":1,"id":1132884020,"name":"中国平安保险公司十堰支公司丹江口办事处"},{"type":1,"id":2844911815,"name":"中国平安保险公司清原代办处"},{"type":1,"id":663656378,"name":"中国平安保险公司新宾代办处"},{"type":1,"id":2747540041,"name":"中国平安保险公司重庆分公司合川办事处铜梁营业部"},{"type":1,"id":2842878296,"name":"中国平安保险公司营口支公司"},{"type":1,"id":948234347,"name":"中国平安保险公司成都分公司中国银行温江支行兼业保险代办处"},{"type":1,"id":871235582,"name":"中国平安保险公司邵阳支公司"},{"type":1,"id":932764014,"name":"中国平安保险公司潍坊支公司高密办事处"},{"type":1,"id":907024011,"name":"中国平安保险公司马鞍山支公司当涂代理处"},{"type":1,"id":907021713,"name":"中国平安保险公司滁州支公司全椒代理处"},{"type":1,"id":694608969,"name":"中国平安保险公司六安支公司"},{"type":1,"id":375859606,"name":"中国平安保险公司重庆分公司涪陵办事处南川代办站"},{"type":1,"id":2579936886,"name":"中国平安保险公司昆明办事处白塔营业部"},{"type":1,"id":663661954,"name":"中国平安保险公司沈阳分公司营业部"},{"type":1,"id":663729658,"name":"中国平安保险公司沈阳分公司大东区办事处"},{"type":1,"id":663731846,"name":"中国平安保险公司沈阳分公司铁西区办事处"},{"type":1,"id":2525504554,"name":"中国平安保险公司淄博支公司"},{"type":1,"id":952125616,"name":"中国平安保险公司南昌办事处宜春地区代办站"},{"type":1,"id":2742508856,"name":"中国平安保险公司武汉分公司黄石市办事处"},{"type":1,"id":2350740625,"name":"中国平安保险公司上海分公司外滩支公司卢湾营业所"},{"type":1,"id":871243535,"name":"中国平安保险公司汨罗市办事处"},{"type":1,"id":871245570,"name":"中国平安保险公司岳阳支公司屈原代理处"},{"type":1,"id":2801859414,"name":"中国平安保险公司天津分公司和平办事处"},{"type":1,"id":2350740635,"name":"中国平安保险公司上海分公司浦东支公司外高桥营业所"},{"type":1,"id":3009518668,"name":"中国平安保险公司泉州办事处"},{"type":1,"id":2350740631,"name":"中国平安保险公司上海分公司虹桥支公司普陀营业所"},{"type":1,"id":2844878921,"name":"中国平安保险公司大连分公司旅顺支公司"},{"type":1,"id":3018130398,"name":"中国平安保险公司延吉支公司敦化代办所"},{"type":1,"id":926081310,"name":"中国平安保险公司桂林营业部"},{"type":1,"id":907334978,"name":"中国平安保险公司长春分公司汽车厂支公司"},{"type":1,"id":951601333,"name":"中国平安保险公司南宁办事处宾阳县营业部"},{"type":1,"id":900570663,"name":"中国平安保险公司长春分公司营业部"},{"type":1,"id":2989882528,"name":"中国平安保险公司南宁办事处横县营业部"},{"type":1,"id":2523945793,"name":"中国平安保险公司日照支公司"},{"type":1,"id":2810601104,"name":"中国平安保险公司天津分公司西青区办事处中国平安保险公司天津分公司西青区办事处中国平安保险公司天津分公司西青区办事处中国平安保险公司天津分公司西青区办事处"},{"type":1,"id":384142089,"name":"中国平安保险公司安庆支公司望江县代理处"},{"type":1,"id":491662850,"name":"中国平安保险公司河南办事处"},{"type":1,"id":295763360,"name":"中国平安保险公司阜阳支公司利辛县代办处"},{"type":1,"id":2352868904,"name":"中国平安保险公司阜阳支公司利辛县代办处（寿险）"},{"type":1,"id":396686194,"name":"中国平安保险公司重庆分公司北碚办事处"},{"type":1,"id":2357393600,"name":"中国平安保险公司兰州分公司"},{"type":1,"id":2989882526,"name":"中国平安保险公司南宁办事处邕宁县营业部"},{"type":1,"id":663657985,"name":"中国平安保险公司抚顺办事处"},{"type":1,"id":2844898999,"name":"中国平安保险公司上海分公司职工技协"},{"type":1,"id":2415996896,"name":"中国平安保险公司石家庄办事处沧州代办处"},{"type":1,"id":663659707,"name":"中国平安保险公司本溪办事处"},{"type":1,"id":2316071910,"name":"中国平安保险公司普兰店支公司"},{"type":1,"id":2350740627,"name":"中国平安保险公司上海分公司市北支公司杨浦营业所"},{"type":1,"id":2844962160,"name":"中国平安保险公司上海分公司浦东支公司川沙营业所"},{"type":1,"id":2844969106,"name":"中国平安保险公司上海分公司浦东支公司陆家嘴营业所"},{"type":1,"id":2801858179,"name":"中国平安保险公司江门办事处开平代办站"},{"type":1,"id":900570317,"name":"中国平安保险公司长春分公司农安代办所"},{"type":1,"id":2844960858,"name":"中国平安保险公司上海分公司浦东支公司金桥营业所
永州支公司宁远寿险代办所"},{"type":1,"id":3187475557,"name":"中国平安保险公司岳阳支公司临湘（寿险）办事处"},{"type":1,"id":3187475564,"name":"中国平安保险公司岳阳支公司临湘办事处"},{"type":1,"id":2992995381,"name":"中国平安保险公司深圳分公司"},{"type":1,"id":3281599827,"name":"中国平安保险公司青岛高科技工业园支公司"},{"type":1,"id":3281717626,"name":"中国平安保险公司福清办事处"},{"type":1,"id":3281717621,"name":"中国平安保险公司福清分理处"},{"type":1,"id":3282039855,"name":"中国平安保险公司潍坊支公司"},{"type":1,"id":3282190448,"name":"中国平安保险公司娄底支公司"},{"type":1,"id":3282924055,"name":"中国平安保险公司南昌办事处吉安地区代办站"},{"type":1,"id":3283022631,"name":"中国平安保险公司南昌办事处"},{"type":1,"id":3283022633,"name":"中国平安保险公司江西代理处"},{"type":1,"id":3283629659,"name":"中国平安保险公司株洲支公司"},{"type":1,"id":3283629664,"name":"中国平安保险公司湖南代理处株洲服务站"},{"type":1,"id":3181862852,"name":"中国平安保险公司兴华证券交易部"},{"type":1,"id":3283668222,"name":"中国平安保险公司湖南代理处"},{"type":1,"id":3181965297,"name":"中国平安保险公司广州白云支公司"},{"type":1,"id":3283700047,"name":"中国平安保险公司东营支公司广饶办事处"},{"type":1,"id":3181965312,"name":"中国平安保险公司广州黄埔经济技术开发区支公司"},{"type":1,"id":3283705519,"name":"中国平安保险公司潍坊支公司安丘办事处"},{"type":1,"id":3181965314,"name":"中国平安保险公司番禺支公司"},{"type":1,"id":3284226498,"name":"中国平安保险公司日照支公司五莲办事处"},{"type":1,"id":3183028713,"name":"中国平安保险公司深圳分公司蛇口支公司"},{"type":1,"id":3183805332,"name":"中国平安保险公司福田证券交易部"},{"type":1,"id":3184457624,"name":"中国平安保险公司（广州）公司从化支公司"},{"type":1,"id":3185787003,"name":"中国平安保险公司苏州支公司"}],"inverst":[{"id":1139343631,"amount":"500.0万","percent":"100.00%","type":1,"name":"中国平安保险公司证券交易珠海营业部"},{"id":601003883,"percent":"100.00%","type":1,"name":"中国平安保险（集团）股份有限公司平安大厦停车场"},{"id":25665063,"amount":"3040600.0万人民币","percent":"100.00%","type":1,"name":"深圳平安金融科技咨询有限公司"},{"id":14289107,"amount":"1298452.0万人民币","percent":"99.88%","type":1,"name":"平安信托有限责任公司"},{"id":22197867,"amount":"148000.0万人民币","percent":"98.67%","type":1,"name":"平安资产管理有限责任公司"},{"id":209251479,"amount":"47500.0万人民币","percent":"95.00%","type":1,"name":"平安健康保险股份有限公司"},{"id":220001796,"amount":"200000.0万人民币","percent":"68.38%","type":1,"name":"平安科技（深圳）有限公司"},{"id":861465605,"amount":"899511.380177万人民币","percent":"67.93%","type":1,"name":"平安国际融资租赁有限公司"},{"id":1551867982,"amount":"15000.0万人民币","percent":"15.00%","type":1,"name":"众安在线财产保险股份有限公司"},{"id":2357863934,"percent":"-","type":1,"name":"平安保险集团"}],"entityType":1,"historyLegal":[]}}
